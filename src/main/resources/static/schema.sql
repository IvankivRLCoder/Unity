...
(
    ...
    photo_name      VARCHAR (128)UNIQUE NOT NULL,
...
INSERT INTO volunteer(id,volunteer_name, surname, email, password, phone, photo_name, date_of_birth, trust_level, is_blocked)
