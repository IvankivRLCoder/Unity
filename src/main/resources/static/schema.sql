...
VALUES ('Task number 1', CURRENT_DATE(), 'Title 1', 10, 'PENDING', '2020-07-17', 'HIGH', 1, 1),
       ('Task number 2', '2020-03-27', 'Title 2', 20, 'PENDING', '2020-05-15', 'LOW', 3, 2),
       ('Task number 3', CURRENT_DATE(), 'Title 3', 2, 'PENDING', '2020-10-10', 'LOW', 2, 2),
       ('Task number 4', '1999-09-09', 'Title 4', 2, 'PENDING', '2020-12-12', 'HIGH', 3, 3);
